      ...
      <div className="mb-8 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Create New Guest</h1>
              <p className="text-blue-100 mt-1">Add a new guest, speaker, or host to your events.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-4 rounded-xl shadow-md border border-gray-100 sticky bottom-4 z-20">
            <Button
              ...
              size="lg"
              isLoading={isLoading}
              className="w-full mb-3 font-bold text-lg shadow-lg bg-gradient-to-r from-blue-600 to-indigo-600"
              startContent={<FaSave />}
            >
              Create Guest
            </Button>
