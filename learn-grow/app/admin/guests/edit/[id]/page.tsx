  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <Spinner size="lg" label="Loading guest..." />
      </div>
    );
  }
      ...
      <div className="p-8">
        <Card className="border-2 border-red-500">
          <CardBody className="p-8 text-center">
            <h2 className="text-2xl font-bold text-red-600 mb-4">Guest Not Found</h2>
            <Button color="primary" onPress={() => router.push("/admin/guests")}>
              Back to Guests
            </Button>
          </CardBody>
        </Card>
  ...
  return (
    <div className="p-8">
      ...
      <div className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-8">Edit Guest</h1>
