...
import { FaRocket, FaGraduationCap, FaBuilding, FaGlobeAsia, FaLightbulb, FaUsers } from "react-icons/fa";
...
export default function NextTarget() {
  const targets = [
    {
      ...
      description: "২০২৬ সালের মধ্যে ১০,০০০+ শিক্ষার্থীকে রোবটিক্স এবং প্রোগ্রামিং শিক্ষা প্রদান",
    ...
    },
    {
      ...
      description: "নতুন কোর্স: আর্টিফিশিয়াল ইন্টেলিজেন্স এবং মেশিন লার্নিং বাংলায়",
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
      {/* Background Accents */}
          ...
          {targets.map((target, index) => (
            ...
            >
              <CardBody className="p-6 text-center">
                <div className={`w-16 h-16 mx-auto rounded-xl bg-gradient-to-br ${target.color} flex items-center justify-center text-white mb-4 shadow-lg`}>
                  {target.icon}
                </div>
          ...
          <Card className="bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 border-0 shadow-2xl">
            <CardBody className="p-8">
              ...
              <p className="text-white text-lg font-medium mb-6 max-w-3xl mx-auto leading-relaxed">
                বাংলাদেশের প্রতিটি শিক্ষার্থীকে বিশ্বমানের প্রযুক্তি শিক্ষা প্রদান করা এবং দেশকে গ্লোবাল 
                টেক হাব হিসেবে গড়ে তোলা। আমরা চাই প্রতিটি বাচ্চা যেন রোবটিক্স, এআই এবং প্রোগ্রামিং শিখে 
                নিজের স্বপ্ন পূরণ করতে পারে।
              </p>
