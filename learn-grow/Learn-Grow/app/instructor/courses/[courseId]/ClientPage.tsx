...
export default function InstructorCourseDashboardClient({
  params,
}: {
      ...
      lessons: [
        {
          ...
          type: "video",
          description: "Brief introduction to course text.",
          isFreePreview: true,
        },
        {
          id: "102",
          ...
          type: "article",
          description: "Step-by-step guide to installing VS Code.",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          type: "video",
          description: "Understanding the DOM.",
        },
        {
          id: "202",
          title: "Working with Text and lists",
          type: "video",
          description: "Tags for text formatting.",
        },
      ],
    },
  ]);
  ...
  const courseData =
    SAMPLE_COURSES.find((c) => c.id === courseId) || SAMPLE_COURSES[0];
  ...
  const getStatusColor = (status: string) =>
    status === "published" || status === "active" ? "success" : "warning";
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            {modules.length === 0 ? (
              <Card className="border-2 border-dashed border-gray-300">
                <CardBody className="p-12 text-center text-gray-500">
                  ...
                  <p className="mb-4">
                    No curriculum content yet. Start by adding a module!
                  </p>
                  <Button
                    color="primary"
                    variant="flat"
                    onPress={onOpenModuleModal}
                  >
                    Create Module
                  </Button>
                </CardBody>
                  ...
                  <AccordionItem
                    ...
                    subtitle={
                      <div className="flex flex-col gap-1">
                        ...
                        {module.description && (
                          <span className="text-xs text-gray-400 max-w-sm truncate">
                            {module.description}
                          </span>
                        )}
                      </div>
        ...
        >
          <Card className="mt-6">
            <CardBody className="p-8 text-center text-gray-500">
              ...
              <p>
                View and manage the {course.enrolled} students enrolled in this
                course.
              </p>
            </CardBody>
          </Card>
          ...
          <div className="mt-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-gray-600">
                  Manage quizzes, exams, and assignments for this course.
                </p>
              </div>
              ...
              <Button
                ...
                onPress={() =>
                  router.push(
                    `/instructor/quizzes/create?courseId=${courseId}&courseTitle=${encodeURIComponent(course.title)}`
                  )
                }
              >
                Create Assessment
                  ...
                  <CardBody className="p-4 flex flex-row items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onPress={() =>
                          router.push(
                            `/instructor/quizzes/${assessment.id}/edit`
                          )
                        }
                      >
                        <FaEdit className="text-gray-500" />
      ...
      <Modal isOpen={isModuleModalOpen} onClose={onCloseModuleModal} size="2xl">
        <ModalContent>
          ...
          <ModalFooter>
            <Button color="danger" variant="light" onPress={onCloseModuleModal}>
              Cancel
            </Button>
            <Button color="primary" onPress={handleSaveModule}>
              Save Module
            </Button>
          </ModalFooter>
        </ModalContent>
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    onPress={() =>
                      setNewLesson({ ...newLesson, type: "video" })
                    }
                  ...
                  <Button
                    ...
                    variant={
                      newLesson.type === "article" ? "solid" : "bordered"
                    }
                    onPress={() =>
                      setNewLesson({ ...newLesson, type: "article" })
                    }
              ...
              >
                ...
                >
                  ...
                  {newLesson.contentUrl &&
                    newLesson.contentUrl.startsWith("blob:") && (
